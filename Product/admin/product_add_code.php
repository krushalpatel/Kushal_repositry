<?php
        ...
        VALUES ('$p_name','$p_description','$p_category','$p_price','$p_sku','$p_barcode','$p_weight','$p_dimension',' $p_quantity',' $p_variants',' $p_shipping_information','$p_seo_information ','$p_brand ','$p_features','$p_benefits','$p_related','$p_review','$p_createdat','$p_img')";
